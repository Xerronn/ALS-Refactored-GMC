...
float UAlsUtility::GetAnimationCurveValueFromCharacter(const AAlsCharacter* Character, const FName& CurveName)
{
	const TObjectPtr Mesh{IsValid(Character) ? Character->GetMesh() : nullptr};
